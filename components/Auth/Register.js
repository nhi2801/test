...
class Register {
  ...
  constructor() {
    ...
    this.$title.innerHTML = "Chào mừng đến với Quizz";
    ...
    this.$inputGroupFullName = new InputGroup("Họ tên", "text", "fullname");
    ...
    this.$contentspan.innerHTML = "Bạn đã có tài khoản?";

    this.$linkhrepSingup = document.createElement("span");
    this.$linkhrepSingup.innerHTML = "Đăng nhập";
  ...
  handelSubmit = (e) => {
    ...
    if (!fullName) {
      this.$inputGroupFullName.setError("Bạn chưa nhập họ tên");
    } else {
