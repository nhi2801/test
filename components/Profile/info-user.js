class InfoUser {
  ...
  constructor() {
    ...
    <h1 title="Dung Nhi" class="">Dung Nhi</h1>
  ...
  <div class="username "> @oloxo9x_28463 <span class="occupation-label  student"> Chuyên nghiệp </span></div>
    `;
    ...
    <div class="edit-profile-btn-wrapper"><button class="btn btn-edit-profile"><i class="far fa-edit"
          aria-hidden="true"></i><span> Chỉnh sửa Thông tin cá nhân </span></button></div>
  </div>
    `;
  ...
  <div class="tabs" role="tablist"><button class="tab tab-quizzes selected" data-tab="quizzes" role="tab"
      aria-selected="true">Các đề thi</button><button class="tab tab-collections " data-tab="collections" role="tab"
      aria-selected="false">Bộ sưu tập</button><button class="tab tab-memesets " data-tab="memesets" role="tab"
      aria-selected="false">Lý thuyết</button><span class="tab-selection quizizz"></span></div>
</div>
  `;
  }
  render() {
