...
<div class="settings-control-wrapper">
  <div class="category-label"><span class="cat-icon cat-user"><i class="fas fa-user"></i></span><span
      class="cat-name">Tài khoản</span></div>
</div>
...
<button class="btn-update" id="update-email">Lưu thay đổi</button>
...
<div class="category-label">
  ...
  <span class="cat-name">Mật khẩu</span>
</div>
<hr class="hr-section" aria-hidden="true">
...
<button class="btn-update" id="update-password">Cập nhật mật khẩu</button>
...
<div class="category-label">
  ...
  <span class="cat-name">Xóa tài khoản</span>
</div>
<hr class="hr-section" aria-hidden="true">
<div class="delete-acc-msg">Xóa tài khoản của bạn vĩnh viễn</div>
<button class="btn-delete">Xóa tài khoản</button>


`;
  } else {
    setting.innerHTML = `
<div>Tính năng đổi thông tin đang phát triển với dạng đăng nhập Google</div>
<div class="signup-header"><img class="settings-logo" src="https://cf.quizizz.com/img/gears_icon.png" alt="">
  <h1 class="title">Cài đặt</h1>
</div>
<div class="settings-control-wrapper">
...
<button class="btn-update btn-disabled " id="update-email">Lưu thay đổi</button>
...
<button class="btn-update btn-disabled  " id="update-password">Cập nhật mật khẩu</button>
